...
@Entity
@Table(name = "tb01_tarifa_frete", schema="controle_frete")
@NamedQuery(name=TarifaFrete.ROTA, query="SELECT o FROM TarifaFrete o WHERE o.cepOrigem = :cepOrigem AND o.cepDestino = :cepDestino ORDER BY o.vrTarifaFrete ")
