...
@Entity
@Table(name = "tb01_evento_solicitacao")
@NamedQueries({
	@NamedQuery(name=EventoSolicitacao.PENDENTES_ENVIO, query="SELECT o FROM EventoSolicitacao o WHERE o.dhEnvioEvento IS NULL ORDER BY o.id.dhRegistro")
})
